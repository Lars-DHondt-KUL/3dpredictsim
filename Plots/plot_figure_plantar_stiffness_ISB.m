...
FigRepo = 'C:\Users\u0150099\OneDrive - KU Leuven\PhD\Conferences\ISB 2023';
...
%     if i_res==length(resultFiles)
% %         if i == 1
%             ylb = ylabel('(J kg^-^1 m^-^1)','Fontsize',label_fontsize,'Interpreter','tex');
%             ylb.Position(2) = 0.5;
% %         end
% 
% %         ylim([yl(1)-0.1*norm(yl),yl(2)+0.1*norm(yl)])
