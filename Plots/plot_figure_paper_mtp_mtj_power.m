...
%
fig2 = figure();
fig2.Position = [269 136 1200/2 250];
tl2 = tiledlayout(1,3);
...
for i=1:6
    ...
    hold on
    Pij = pos_P_all{i};
    plot(x,Pij(idx_stance),'linewidth',line_linewidth,'Color',CsV{i_res},...
