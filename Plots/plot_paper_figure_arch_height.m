...
resultFiles = {
    ...
    fullfile([ResultsRepo '\results_paper\Fal_s1_mtp_FK_sd_cspx10_cg9_o1x10_ATx50_TFMox120_Fpsl10_MTPp_k25_d020_tau_ig21_N100_pp.mat'])
    };
LegNames = {'Regular arch height (3-S)','Regular arch height (2-S)',...
    'Low arch height (3-S)','Low arch height  (2-S)'};


joints_ref = {'knee_angle','ankle_angle','subtalar_angle','mtj_angle'};
joints_tit = {'Knee','Ankle','Subtalar','Midtarsal'};
...
xlabel('Low arch height','Fontsize',label_fontsize,'Color','k')
...
tmp.XAxis.Color = 'w';
tmp.YAxis.Visible = 'off';
xlabel('Regular arch height','Fontsize',label_fontsize,'Color','k')
% title('Regular arch height','Fontsize',title_fontsize);

%%

str = '(a)';
annotation(gcf,'textbox',[0.07,0.95,0.05,0.05],'String',str,'EdgeColor','none','FontSize',12);

str = '(b)';
annotation(gcf,'textbox',[0.63,0.95,0.05,0.05],'String',str,'EdgeColor','none','FontSize',12);

str = '(c)';
annotation(gcf,'textbox',[0.77,0.95,0.05,0.05],'String',str,'EdgeColor','none','FontSize',12);


str = '(d)';
annotation(gcf,'textbox',[0.07,0.48,0.05,0.05],'String',str,'EdgeColor','none','FontSize',12);


str = '(e)';
annotation(gcf,'textbox',[0.63,0.48,0.05,0.05],'String',str,'EdgeColor','none','FontSize',12);



exportgraphics(fig2,fullfile(FigRepo,'figure_arch_height.jpeg'),'Resolution',300);
