...
int F_generic(const T** arg, T** res) {
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_r_location(0.01499999999999999944, 0.01000000000000000021, -0.00500000000000000010);
	...
	SmoothSphereHalfSpaceForce_s2_r = new SmoothSphereHalfSpaceForce("SmoothSphereHalfSpaceForce_s2_r", *forefoot_r, model->getGround());
	Vec3 SmoothSphereHalfSpaceForce_s2_r_location(0.01700000000000000122, -0.00899999999999999932, 0.02699999999999999969);
	SmoothSphereHalfSpaceForce_s2_r->set_contact_sphere_location(SmoothSphereHalfSpaceForce_s2_r_location);
	double SmoothSphereHalfSpaceForce_s2_r_radius = (0.02299999999999999961);
	...
	SmoothSphereHalfSpaceForce_s2_r->connectSocket_sphere_frame(*forefoot_r);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_r_location(0.05000000000000000278, -0.01040600000000000032, 0.02500000000000000139);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_r_location(0.06397020000000000484, -0.01140599999999999947, -0.02500000000000000139);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_r_location(0.05315399999999999986, -0.00153853999999999992, -0.02500000000000000139);
	...
	Vec3 SmoothSphereHalfSpaceForce_s6_r_location(0.03500000000000000333, -0.00053854000000000000, 0.01000000000000000021);
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_l_location(0.01499999999999999944, 0.01000000000000000021, 0.00500000000000000010);
	...
	SmoothSphereHalfSpaceForce_s2_l = new SmoothSphereHalfSpaceForce("SmoothSphereHalfSpaceForce_s2_l", *forefoot_l, model->getGround());
	Vec3 SmoothSphereHalfSpaceForce_s2_l_location(0.01700000000000000122, -0.00899999999999999932, -0.02699999999999999969);
	SmoothSphereHalfSpaceForce_s2_l->set_contact_sphere_location(SmoothSphereHalfSpaceForce_s2_l_location);
	double SmoothSphereHalfSpaceForce_s2_l_radius = (0.02299999999999999961);
	...
	SmoothSphereHalfSpaceForce_s2_l->connectSocket_sphere_frame(*forefoot_l);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_l_location(0.05000000000000000278, -0.01040600000000000032, -0.02500000000000000139);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_l_location(0.06397020000000000484, -0.01140599999999999947, 0.02500000000000000139);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_l_location(0.05315399999999999986, -0.00153853999999999992, 0.02500000000000000139);
	...
	Vec3 SmoothSphereHalfSpaceForce_s6_l_location(0.03500000000000000333, -0.00053854000000000000, -0.01000000000000000021);
	...
	int c_idx_1 = model->getBodySet().get("forefoot_r").getMobilizedBodyIndex();
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_r_location_G = forefoot_r->findStationLocationInGround(*state, SmoothSphereHalfSpaceForce_s2_r_location);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_r_locationCP_B = model->getGround().findStationLocationInAnotherFrame(*state, locationCP_G_adj_1, *forefoot_r);
	Vec3 GRM_1 = (TR_GB_forefoot_r*SmoothSphereHalfSpaceForce_s2_r_locationCP_B) % GRF_1[1];
	GRM_r += GRM_1;
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_l_location_G = forefoot_l->findStationLocationInGround(*state, SmoothSphereHalfSpaceForce_s2_l_location);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_l_locationCP_B = model->getGround().findStationLocationInAnotherFrame(*state, locationCP_G_adj_7, *forefoot_l);
	Vec3 GRM_7 = (TR_GB_forefoot_l*SmoothSphereHalfSpaceForce_s2_l_locationCP_B) % GRF_7[1];
	GRM_l += GRM_7;
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_r_velocity_G = forefoot_r->findStationVelocityInGround(*state, SmoothSphereHalfSpaceForce_s2_r_location);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_l_velocity_G = forefoot_l->findStationVelocityInGround(*state, SmoothSphereHalfSpaceForce_s2_l_location);
