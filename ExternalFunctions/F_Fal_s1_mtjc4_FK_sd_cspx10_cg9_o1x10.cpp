...
int F_generic(const T** arg, T** res) {
	...
	st_midtarsal_r[0].setAxis(Vec3(0.39508999999999999675, -0.21074999999999999289, 0.89414000000000004587));
	...
	st_midtarsal_l[0].setAxis(Vec3(-0.39508999999999999675, 0.21074999999999999289, 0.89414000000000004587));
