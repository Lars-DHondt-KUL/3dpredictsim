...
int F_generic(const T** arg, T** res) {
	...
	SpatialTransform st_midtarsal_r;
	st_midtarsal_r[0].setCoordinateNames(OpenSim::Array<std::string>("mtj_angle_r", 1, 1));
	st_midtarsal_r[0].setFunction(new LinearFunction(1.0000, 0.0000));
	st_midtarsal_r[0].setAxis(Vec3(0.02013200000000000059, -0.30092999999999997529, 0.95343999999999995421));
	st_midtarsal_r[1].setFunction(new Constant(0.00000000000000000000));
	st_midtarsal_r[1].setAxis(Vec3(0.00000000000000000000, 1.00000000000000000000, 0.00000000000000000000));
	st_midtarsal_r[2].setFunction(new Constant(0.00000000000000000000));
	st_midtarsal_r[2].setAxis(Vec3(0.00000000000000000000, 0.00000000000000000000, 1.00000000000000000000));
	st_midtarsal_r[3].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 1.02410000000000001030));
	st_midtarsal_r[3].setAxis(Vec3(1.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	st_midtarsal_r[4].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 1.18239999999999989555));
	st_midtarsal_r[4].setAxis(Vec3(0.00000000000000000000, 1.00000000000000000000, 0.00000000000000000000));
	st_midtarsal_r[5].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 1.14700000000000001954));
	st_midtarsal_r[5].setAxis(Vec3(0.00000000000000000000, 0.00000000000000000000, 1.00000000000000000000));
	OpenSim::CustomJoint* midtarsal_r;
	midtarsal_r = new OpenSim::CustomJoint("midtarsal_r", *calcn_r, Vec3(0.07481650116859279998, 0.01796057191985147433, -0.00655047979926234956), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *midfoot_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_midtarsal_r);
	...
	st_mtp_r[0].setAxis(Vec3(-0.28299699999999999855, 0.04242230000000000306, 0.95818199999999997818));
	...
	mtp_r = new OpenSim::CustomJoint("mtp_r", *forefoot_r, Vec3(0.06000577935548710024, -0.01023989527572480990, 0.00289855694891915294), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *toes_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_mtp_r);
	...
	SpatialTransform st_midtarsal_l;
	st_midtarsal_l[0].setCoordinateNames(OpenSim::Array<std::string>("mtj_angle_l", 1, 1));
	st_midtarsal_l[0].setFunction(new LinearFunction(1.0000, 0.0000));
	st_midtarsal_l[0].setAxis(Vec3(-0.02013200000000000059, 0.30092999999999997529, 0.95343999999999995421));
	st_midtarsal_l[1].setFunction(new Constant(0.00000000000000000000));
	st_midtarsal_l[1].setAxis(Vec3(0.00000000000000000000, 1.00000000000000000000, 0.00000000000000000000));
	st_midtarsal_l[2].setFunction(new Constant(0.00000000000000000000));
	st_midtarsal_l[2].setAxis(Vec3(0.00000000000000000000, 0.00000000000000000000, 1.00000000000000000000));
	st_midtarsal_l[3].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 1.02410000000000001030));
	st_midtarsal_l[3].setAxis(Vec3(1.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	st_midtarsal_l[4].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 1.18239999999999989555));
	st_midtarsal_l[4].setAxis(Vec3(0.00000000000000000000, 1.00000000000000000000, 0.00000000000000000000));
	st_midtarsal_l[5].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 1.14700000000000001954));
	st_midtarsal_l[5].setAxis(Vec3(0.00000000000000000000, 0.00000000000000000000, 1.00000000000000000000));
	OpenSim::CustomJoint* midtarsal_l;
	midtarsal_l = new OpenSim::CustomJoint("midtarsal_l", *calcn_l, Vec3(0.07481650116859279998, 0.01796057191985147433, 0.00655047979926234956), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *midfoot_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_midtarsal_l);
	...
	st_mtp_l[0].setAxis(Vec3(0.28299699999999999855, -0.04242230000000000306, 0.95818199999999997818));
	...
	mtp_l = new OpenSim::CustomJoint("mtp_l", *forefoot_l, Vec3(0.06000577935548710024, -0.01023989527572480990, -0.00289855694891915294), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *toes_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_mtp_l);
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_r_location(0.01000000000000000021, 0.00692291751087808875, -0.00499720000000000025);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_r_location(0.05999999999999999778, 0.01192291751087808972, 0.02000100000000000142);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_r_location(0.06397016935567800822, -0.00500000000000000010, 0.02274865219000000646);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_r_location(0.06397016935567800822, -0.00500000000000000010, -0.00843404780999999423);
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_l_location(0.01000000000000000021, 0.00692291751087808875, 0.00499720000000000025);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_l_location(0.05999999999999999778, 0.01192291751087808972, -0.02000100000000000142);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_l_location(0.06397016935567800822, -0.00500000000000000010, -0.02274865219000000646);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_l_location(0.06397016935567800822, -0.00500000000000000010, 0.00843404780999999423);
	...
	Array<osim_double_adouble> Force_5 = SmoothSphereHalfSpaceForce_s1_l->getRecordValues(*state);
	SpatialVec GRF_5;
	...
	Array<osim_double_adouble> Force_6 = SmoothSphereHalfSpaceForce_s2_l->getRecordValues(*state);
	SpatialVec GRF_6;
	...
	Array<osim_double_adouble> Force_7 = SmoothSphereHalfSpaceForce_s3_l->getRecordValues(*state);
	SpatialVec GRF_7;
	GRF_7[0] = Vec3(Force_7[3], Force_7[4], Force_7[5]);
	GRF_7[1] = Vec3(Force_7[0], Force_7[1], Force_7[2]);
	int c_idx_7 = model->getBodySet().get("forefoot_l").getMobilizedBodyIndex();
	appliedBodyForces[c_idx_7] += GRF_7;

	Array<osim_double_adouble> Force_8 = SmoothSphereHalfSpaceForce_s4_l->getRecordValues(*state);
	SpatialVec GRF_8;
	...
	Array<osim_double_adouble> Force_9 = SmoothSphereHalfSpaceForce_s5_l->getRecordValues(*state);
	SpatialVec GRF_9;
	...
	Vec3 locationCP_G_adj_5 = SmoothSphereHalfSpaceForce_s1_l_locationCP_G - 0.5*SmoothSphereHalfSpaceForce_s1_l_locationCP_G[1] * normal;
	Vec3 SmoothSphereHalfSpaceForce_s1_l_locationCP_B = model->getGround().findStationLocationInAnotherFrame(*state, locationCP_G_adj_5, *calcn_l);
	Vec3 GRM_5 = (TR_GB_calcn_l*SmoothSphereHalfSpaceForce_s1_l_locationCP_B) % GRF_5[1];
	GRM_l += GRM_5;
	...
	Vec3 locationCP_G_adj_6 = SmoothSphereHalfSpaceForce_s2_l_locationCP_G - 0.5*SmoothSphereHalfSpaceForce_s2_l_locationCP_G[1] * normal;
	Vec3 SmoothSphereHalfSpaceForce_s2_l_locationCP_B = model->getGround().findStationLocationInAnotherFrame(*state, locationCP_G_adj_6, *calcn_l);
	Vec3 GRM_6 = (TR_GB_calcn_l*SmoothSphereHalfSpaceForce_s2_l_locationCP_B) % GRF_6[1];
	GRM_l += GRM_6;
	...
	Vec3 locationCP_G_adj_7 = SmoothSphereHalfSpaceForce_s3_l_locationCP_G - 0.5*SmoothSphereHalfSpaceForce_s3_l_locationCP_G[1] * normal;
	Vec3 SmoothSphereHalfSpaceForce_s3_l_locationCP_B = model->getGround().findStationLocationInAnotherFrame(*state, locationCP_G_adj_7, *forefoot_l);
	Vec3 GRM_7 = (TR_GB_forefoot_l*SmoothSphereHalfSpaceForce_s3_l_locationCP_B) % GRF_7[1];
	GRM_l += GRM_7;
	...
	Vec3 locationCP_G_adj_8 = SmoothSphereHalfSpaceForce_s4_l_locationCP_G - 0.5*SmoothSphereHalfSpaceForce_s4_l_locationCP_G[1] * normal;
	Vec3 SmoothSphereHalfSpaceForce_s4_l_locationCP_B = model->getGround().findStationLocationInAnotherFrame(*state, locationCP_G_adj_8, *forefoot_l);
	Vec3 GRM_8 = (TR_GB_forefoot_l*SmoothSphereHalfSpaceForce_s4_l_locationCP_B) % GRF_8[1];
	GRM_l += GRM_8;
	...
	Vec3 locationCP_G_adj_9 = SmoothSphereHalfSpaceForce_s5_l_locationCP_G - 0.5*SmoothSphereHalfSpaceForce_s5_l_locationCP_G[1] * normal;
	Vec3 SmoothSphereHalfSpaceForce_s5_l_locationCP_B = model->getGround().findStationLocationInAnotherFrame(*state, locationCP_G_adj_9, *toes_l);
	Vec3 GRM_9 = (TR_GB_toes_l*SmoothSphereHalfSpaceForce_s5_l_locationCP_B) % GRF_9[1];
	GRM_l += GRM_9;
	...
	osim_double_adouble P_HC_y_5 = SmoothSphereHalfSpaceForce_s1_l_velocity_G[1]*GRF_5[1][1];
	...
	osim_double_adouble P_HC_y_6 = SmoothSphereHalfSpaceForce_s2_l_velocity_G[1]*GRF_6[1][1];
	...
	osim_double_adouble P_HC_y_7 = SmoothSphereHalfSpaceForce_s3_l_velocity_G[1]*GRF_7[1][1];
	...
	osim_double_adouble P_HC_y_8 = SmoothSphereHalfSpaceForce_s4_l_velocity_G[1]*GRF_8[1][1];
	...
	osim_double_adouble P_HC_y_9 = SmoothSphereHalfSpaceForce_s5_l_velocity_G[1]*GRF_9[1][1];
	/// Outputs.
