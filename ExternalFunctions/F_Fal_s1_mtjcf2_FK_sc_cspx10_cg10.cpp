...
int F_generic(const T** arg, T** res) {
	...
	st_midtarsal_r[0].setAxis(Vec3(-0.45100000000000001199, -0.36799999999999999378, 0.81310000000000004494));
	...
	st_midtarsal_l[0].setAxis(Vec3(0.45100000000000001199, 0.36799999999999999378, 0.81310000000000004494));
