...
int F_generic(const T** arg, T** res) {
	...
	st_midtarsal_r[0].setAxis(Vec3(-0.68142999999999998018, -0.33707999999999999075, 0.64963999999999999524));
	...
	st_midtarsal_l[0].setAxis(Vec3(0.68142999999999998018, 0.33707999999999999075, 0.64963999999999999524));
