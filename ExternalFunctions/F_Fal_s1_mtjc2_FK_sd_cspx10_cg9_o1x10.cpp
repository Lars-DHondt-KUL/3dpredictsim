...
int F_generic(const T** arg, T** res) {
	...
	st_midtarsal_r[0].setAxis(Vec3(-0.35788999999999998591, -0.34527999999999997582, 0.86758000000000001783));
	...
	st_midtarsal_l[0].setAxis(Vec3(0.35788999999999998591, 0.34527999999999997582, 0.86758000000000001783));
