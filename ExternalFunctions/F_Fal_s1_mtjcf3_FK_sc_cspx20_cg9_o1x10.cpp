...
int F_generic(const T** arg, T** res) {
	...
	st_midtarsal_r[0].setAxis(Vec3(-0.22580000000000000071, -0.40410000000000001474, 0.88639999999999996572));
	...
	st_midtarsal_l[0].setAxis(Vec3(0.22580000000000000071, 0.40410000000000001474, 0.88639999999999996572));
