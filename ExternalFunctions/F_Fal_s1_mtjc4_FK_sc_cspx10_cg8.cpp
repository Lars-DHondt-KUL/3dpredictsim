...
int F_generic(const T** arg, T** res) {
	...
	midtarsal_r = new OpenSim::CustomJoint("midtarsal_r", *calcn_r, Vec3(0.07723073660730933598, 0.02919002465610008590, -0.00743489299800000319), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *midfoot_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_midtarsal_r);
	...
	midtarsal_l = new OpenSim::CustomJoint("midtarsal_l", *calcn_l, Vec3(0.07723073660730933598, 0.02919002465610008590, 0.00743489299800000319), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *midfoot_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_midtarsal_l);
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_r_location(0.02000000000000000042, 0.00692291751087808875, -0.00499720000000000025);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_r_location(0.05000000000000000278, -0.01140601012581093227, 0.02274865219000000646);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_r_location(0.06397016935567800822, -0.01140601012581093227, -0.01499999999999999944);
	SmoothSphereHalfSpaceForce_s4_r->set_contact_sphere_location(SmoothSphereHalfSpaceForce_s4_r_location);
	double SmoothSphereHalfSpaceForce_s4_r_radius = (0.02299999999999999961);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_r_location(0.05315399999999999986, -0.00153854124456095573, -0.02000000000000000042);
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_l_location(0.02000000000000000042, 0.00692291751087808875, 0.00499720000000000025);
	...
	Vec3 SmoothSphereHalfSpaceForce_s3_l_location(0.05000000000000000278, -0.01140601012581093227, -0.02274865219000000646);
	...
	Vec3 SmoothSphereHalfSpaceForce_s4_l_location(0.06397016935567800822, -0.01140601012581093227, 0.01499999999999999944);
	SmoothSphereHalfSpaceForce_s4_l->set_contact_sphere_location(SmoothSphereHalfSpaceForce_s4_l_location);
	double SmoothSphereHalfSpaceForce_s4_l_radius = (0.02299999999999999961);
	...
	Vec3 SmoothSphereHalfSpaceForce_s5_l_location(0.05315399999999999986, -0.00153854124456095573, 0.02000000000000000042);
