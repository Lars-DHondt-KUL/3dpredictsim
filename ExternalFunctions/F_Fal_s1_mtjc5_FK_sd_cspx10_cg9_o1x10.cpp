...
int F_generic(const T** arg, T** res) {
	...
	st_midtarsal_r[0].setAxis(Vec3(0.70989999999999997549, -0.08849500000000000421, 0.69872000000000000774));
	...
	st_midtarsal_l[0].setAxis(Vec3(-0.70989999999999997549, 0.08849500000000000421, 0.69872000000000000774));
